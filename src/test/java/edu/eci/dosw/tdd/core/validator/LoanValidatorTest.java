...
class LoanValidatorTest {
    ...
    void validateLoanCreation_ShouldThrowException_WhenUserIsNull() {
        Book book = Book.builder().id("b1").build();
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> validator.validateLoanCreation(null, book));
    ...
    void validateLoanCreation_ShouldThrowException_WhenBookIsNull() {
        User user = User.builder().id("u1").build();
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> validator.validateLoanCreation(user, null));
